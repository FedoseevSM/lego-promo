...
const SuccessStoryBurger = () => {
  ...
  const burgerLayers = [
    ...
    id: 4,
    number: 4,
    title: "Фричайзинг — новая бизнес-модель",
    label: "Слой 4 - Фричайзинг",
    colorClass: "layer-4",
    gradient: "from-[#00b09b]/15 to-[#96c93d]/10",
    borderColor: "border-l-[#00b09b]",
    numberColor: "bg-[#00b09b]/30 text-[#00b09b]",
    iconColor: "text-[#00b09b]",
    description: "Создал инновационную бизнес-модель 'Фричайзинг' для 24-формата, адаптированную под восточное понимание бизнеса. Передаю готовые шаблоны через Open Source, активно веду блог, YouTube-канал, обучающие программы и социальную активность для масштабирования сообщества.",
    achievement: {
      title: "Достигнутый результат:",
      description: "Запущена масштабируемая бизнес-модель Фричайзинг с открытым доступом к шаблонам через Open Source. Создано активное сообщество предпринимателей с растущей аудиторией в блоге и YouTube-канале.",
      points: [
        "Разработка уникальной модели Фричайзинг для круглосуточного бизнеса",
        "Создание и публикация готовых шаблонов через Open Source репозитории",
        "Активное ведение YouTube-канала и блога с обучающим контентом",
        "Формирование сообщества фричейзинговых партнеров и масштабирование"
      ]
    }
  }
  ];
